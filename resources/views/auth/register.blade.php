                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="phone-register">
                                    <p>+63</p>
                                    <input id="phone" type="text" class="form-control @error('phone') is-invalid @enderror" name="phone_number" value="{{ old('phone_number') }}" required autocomplete="phone_number" maxlength="10" autofocus>
                                </div>
