                ...
                <div class="card-body bodyRegister">
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6 registerName">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <select name="gender" id="gender" class="form-select @error('gender') is-invalid @enderror" required autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="age" type="number" class="form-control @error('age') is-invalid @enderror" name="age" value="{{ old('age') }}" autocomplete="age" readonly>
                        ...
                        <div class="row mb-3">
                            <label for="birthplace" class="col-md-4 col-form-label text-md-end">{{ __('Birthplace') }}</label>

                            <div class="col-md-6 registerBirthplace">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <div class="phone-register">
                                    <p>+63</p>
                                    <input id="phone_number" type="text" class="form-control @error('phone_number') is-invalid @enderror" name="phone_number" value="{{ old('phone_number') }}" required autocomplete="phone_number" maxlength="10" autofocus>
                                </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6 registerAddress">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input id="username" type="text" class="form-control @error('username') is-invalid @enderror" name="username" value="{{ old('username') }}" required autocomplete="username" minlength="6" autofocus>
