            ...
            <div class="modal-content">
                ...
                <div class="modal-body studentForm">
                    ...
                    <form action="{{route('createStudent')}}" method="POST">
                        ...
                        <input id="fullname" type="text" name="name" hidden>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body studentForm">
                    ...
                    <form method="POST">
                        ...
                        <input id="edit-fullname" type="text" name="name" hidden>
                        <div id="fullname-error" class="alert alert-danger" role="alert" style="display:none"></div>
